...
var Webhook = exports.Webhook = function (options) {
    ...
    this.path = options.path || '/wide-log';
...
//
// ### function log (level, msg, [data], callback)
...
//
Webhook.prototype.log = function (rec, callback) {
    if (this.silent) {
        return callback(null, true);
    }

    var self = this,
        data = cycle.decycle(rec.data),
        message = common.clone(data),
        options,
        req;
