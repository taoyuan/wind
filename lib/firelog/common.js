/*
 * common.js: Internal helper and utility functions for firelog
 *
...
exports.log = function (options) {
    ...
    var colorize = options.colorize ? config.colorize : function (s) { return s; };
    ...
    output += ': ';
    output += options.label ? ('[' + colorize(options.level, options.label) + '] ') : '';
