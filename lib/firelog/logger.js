/*
 * logger.js: Core logger object used by firelog.
 *
...
//
// ### function log (level, [id], msg, [meta], callback)
...
Logger.prototype.profile = function (id) {
    ...
    if (this.profilers[id]) {
        ...
        return this.info(id, msg, meta, callback);
    }
    else {
...
//
Logger.prototype.cli = function (appname) {
    var that = this;
    this.padLevels = true;
